    ...
    return {
        ...
        initChat: function () {
            ...
            var handleClick = function () {
                var user_id = $('.rows_user.active a').data('id');
                var text = input.val();
                ...
                var author_id = $(this).data('id'),
                    ...
                    author_avatar = $(this).data('avatar');
                var time = new Date();
                var time_str = time.getHours()+':'+time.getMinutes()+':'+time.getSeconds();
                var tpl = '';
                tpl += '<li class="out">';
                tpl += '<img class="avatar" alt="" src="'+author_avatar+'"/>';
                tpl += '<div class="message">';
                tpl += '<span class="arrow"></span>';
                tpl += '<a href="#" class="name">'+author_name+'</a>&nbsp;';
                ...
                $.ajax({
                    type: 'POST',
                    url: 'http://' + location.host + '/welcome/save_messages',
                    data: {
                        'recipient_id': user_id,'message': text
                    },
                    dataType: 'html',
